...
export const PERSONALITIES: Readonly<Record<CoachPackId, PersonalityProfile>> = {
  technical: {
    ...
    introduction: {
      ...
      transition: ["Let's get to work.", "Here we go — clean and precise."],
      energy: 'calm',
    },
  },
  ...
  oldschool: {
    ...
    introduction: {
      ...
      transition: ["Let's work.", 'Time to work.'],
      energy: 'steady',
    },
  },
  ...
  fightnight: {
    ...
    introduction: {
      ...
      transition: ["Let's go to work.", 'Here we go.'],
      energy: 'rising',
    },
  },
  ...
  calm: {
    ...
    introduction: {
      ...
      transition: ["Let's ease in.", 'Nice and easy — here we go.'],
      energy: 'calm',
    },
  },
  ...
  competition: {
    ...
    introduction: {
      ...
      transition: ["Let's set the standard.", 'Time to work.'],
      energy: 'steady',
    },
  },
  ...
  southpaw: {
    ...
    introduction: {
      ...
      transition: ["Let's get to work.", 'Here we go.'],
      energy: 'steady',
    },
  },
};
