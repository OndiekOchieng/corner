...
- **Placement & weight:** below the preparation copy, styled **quiet and secondary** (muted
  text, dotted underline) — never a loud primary CTA. It is an escape hatch, so it must not
  compete with the calm of the room or imply the athlete *should* tap it.
